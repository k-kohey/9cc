...
assert 3 'int main() { int a=1; return a+2; }'
assert 8 'int main() { int a=3; int z=5; return a+z; }'
assert 3 'int main() { int hoge=1; return hoge+2; }'
assert 2 'int main() { int hoge=3; int fuga=1; return hoge-fuga; }'
assert 2 'int main() { return 2; }'
assert 3 'int main() { int a=3; return a; }'
assert 4 'int main() { int hoge=3; int fuga=1; return hoge+fuga; }'
